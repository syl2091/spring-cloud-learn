...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public com.lege.avro.model.ClientIdentifier clientIdentifier;
  @Deprecated public java.util.List<CharSequence> employeeNames;
  @Deprecated public com.lege.avro.model.Active active;
   ...
   */
  public AvroHttpRequest(Long requestTime, com.lege.avro.model.ClientIdentifier clientIdentifier, java.util.List<CharSequence> employeeNames, com.lege.avro.model.Active active) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: clientIdentifier = (com.lege.avro.model.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<CharSequence>)value$; break;
    case 3: active = (com.lege.avro.model.Active)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.lege.avro.model.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(com.lege.avro.model.ClientIdentifier value) {
   ...
   */
  public com.lege.avro.model.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(com.lege.avro.model.Active value) {
    this.active = value;
  }
   ...
   */
  public static com.lege.avro.model.AvroHttpRequest.Builder newBuilder() {
    return new com.lege.avro.model.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.lege.avro.model.AvroHttpRequest.Builder newBuilder(com.lege.avro.model.AvroHttpRequest.Builder other) {
    return new com.lege.avro.model.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.lege.avro.model.AvroHttpRequest.Builder newBuilder(com.lege.avro.model.AvroHttpRequest other) {
    return new com.lege.avro.model.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private com.lege.avro.model.ClientIdentifier clientIdentifier;
    private com.lege.avro.model.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<CharSequence> employeeNames;
    private com.lege.avro.model.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.lege.avro.model.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = com.lege.avro.model.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.lege.avro.model.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lege.avro.model.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lege.avro.model.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lege.avro.model.AvroHttpRequest.Builder setClientIdentifier(com.lege.avro.model.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public com.lege.avro.model.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(com.lege.avro.model.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(com.lege.avro.model.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.lege.avro.model.AvroHttpRequest.Builder setClientIdentifierBuilder(com.lege.avro.model.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lege.avro.model.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lege.avro.model.AvroHttpRequest.Builder setEmployeeNames(java.util.List<CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lege.avro.model.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lege.avro.model.AvroHttpRequest.Builder setActive(com.lege.avro.model.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lege.avro.model.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (com.lege.avro.model.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (com.lege.avro.model.Active) defaultValue(fields()[3]);
        return record;
      } catch (Exception e) {
